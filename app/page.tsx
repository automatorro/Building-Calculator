        ...
        <div style={{ maxWidth:1160, margin:'0 auto' }}>
          ...
          <div className="pricing-grid" style={{ display:'grid',
            ...
            <div className="reveal reveal-d2" style={{
              ...
              <ul style={{ listStyle:'none', marginBottom:28 }}>
                {['Proiecte nelimitate','Catalog complet 1.100+ articole',
                  ...
                  'Deviz partajat pentru beneficiar','Import extras cantități Excel',
                  'Comparator prețuri furnizori','Export Excel și PDF profesional',
                  'AI Consultant tehnic în deviz','AI Generare rețete resurse automat',
                  'AI Analiză și optimizare deviz'].map(f => (
                  <li key={f} style={{ display:'flex', alignItems:'flex-start', gap:10,
            ...
            <div className="price-card-hover reveal reveal-d4" style={{
              ...
              <div style={{ fontSize:13, color:'#A8A59E', marginBottom:28 }}>/ lună · manager + până la 4 maiștri</div>
              <div style={{ height:1, background:'#E5E3DE', marginBottom:24 }} />
              <ul style={{ listStyle:'none', marginBottom:28 }}>
                {['Tot din planul Constructor','5 conturi — manager + maiștri',
                  'Asignare proiecte pe responsabili','Jurnal de șantier partajat în timp real',
                  'Raport progres per utilizator și etapă','Catalog propriu al firmei cu prețuri personalizate',
                  'AI pentru toți utilizatorii (limite extinse)','Suport prioritar — răspuns în 24h'].map(f => (
                  <li key={f} style={{ display:'flex', alignItems:'flex-start', gap:10,
                    fontSize:14, color:'#2E2D2A', marginBottom:12, lineHeight:1.45, fontWeight:300 }}>
                    <Check /> {f}
                  </li>
