...
import { Calendar, User, ChevronLeft, Share2, Loader2, FileText } from 'lucide-react'
  ...
  if (loading) {
    return (
      <div className="flex h-screen w-full items-center justify-center bg-[#FAFAF8]">
        <Loader2 className="h-10 w-10 animate-spin text-[#E8500A]" />
      </div>
    )
  }
  ...
  return (
    <article className="min-h-screen bg-[#FAFAF8] pb-24">
      ...
      <style jsx global>{`
        ...
        .blog-content-renderer img { border-radius: 1rem; max-width: 100%; height: auto; margin: 2.5rem auto; display: block; box-shadow: 0 10px 30px rgba(0,0,0,0.05); }
