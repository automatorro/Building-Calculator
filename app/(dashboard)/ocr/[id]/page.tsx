...
export default async function OcrPage({ params }: { params: { id: string } }) {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center',
      ...
      <div>
        <h2 style={{ fontFamily: 'var(--font-dm-serif,"DM Serif Display",Georgia,serif)',
          ...
          Extragere OCR — În curând
        </h2>
        <p style={{ fontSize: 14, color: '#6B6860', maxWidth: 360, lineHeight: 1.6 }}>
          Funcționalitatea de extragere automată din planșe și devize scanate va fi disponibilă în curând.
        </p>
      </div>
