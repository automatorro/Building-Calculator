...
export default function Page() {
  ...
  const { volumeM3, pieces, rowsComputed, totalReq, totalOpt, grand, grandVat } = useMemo(() => {
    const vatRate = 0.21
    ...
    const g = req + opt
    return { volumeM3: vM3, pieces: pcs, rowsComputed: computed, totalReq: req, totalOpt: opt, grand: g, grandVat: g * (1 + vatRate) }
